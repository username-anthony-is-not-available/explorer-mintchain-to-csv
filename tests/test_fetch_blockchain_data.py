...
def test_fetch_data_handles_no_transactions_found_with_no_transactions(mocked_responses, caplog):
    """
    ...
    assert f"API response for {mock_url} does not contain a list in 'result'" not in caplog.text
